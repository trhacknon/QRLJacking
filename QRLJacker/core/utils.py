...
def banner(m):
    ...
    banner_to_print  = Bold+G + banner.format(Name=f"{end+R}QrlJacker-Framework {end+B}By {Bold}@trhacknon -{M} V{v+end+Bold+G}",
                                      Description=f"{end+C}Attack vector By trhacknon anonymous {end+Bold+B}(@trhacknon){end+Bold+G}",
